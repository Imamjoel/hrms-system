package com.chemco.hrms.resource;

import com.chemco.hrms.exception.*;
import com.chemco.hrms.model.HttpResponse;
...
import static com.chemco.hrms.constant.FileConstant.*;
import static com.chemco.hrms.constant.SecurityConstant.JWT_TOKEN_HEADER;
import static org.springframework.http.HttpStatus.*;
import static org.springframework.http.MediaType.IMAGE_JPEG_VALUE;

@RestController
@Api(value="user", description="Example operations for user")
@RequestMapping(path = {"/","/user"})
public class UserResource extends ExceptionGlobalHandling {
